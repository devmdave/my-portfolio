...
const Sidebar = () => {
  return (
    <div className="fixed top-50 left-0 h-[30vh] w-10 flex flex-col items-center bg-white shadow-lg z-50">
      ...
      <a href="https://linkedin.com/" target="_blank" rel="noopener noreferrer" className="my-6">
        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="black" viewBox="0 0 16 16">
