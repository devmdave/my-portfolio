    ...
    <nav className='bg-transparent mb-10 flex max-md:flex-col flex-row text-white p-4'>
        ...
        <div className="w-[100%]max-md:w-full mt-[4vh] max-md:mt-[4vh] max-md:rounded-full max-md:bg-white mb-10 poppins-light uppercase max-md:flex-col flex justify-center items-center">
          ...
          <div className='flex max-md:hidden max-md:mt-[4vh] flex-row max-md:space-x-12 space-x-4 mx-8'>
            ...
            <a target='_blank' href='https://stackoverflow.com/users/23113631/dev-mdave'><svg className='max-md:size-8' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" class="bi bi-stack-overflow" viewBox="0 0 16 16">
            ...
            <a target="_blank" href=''><svg className='max-md:size-8' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" class="bi bi-linkedin" viewBox="0 0 16 16">
