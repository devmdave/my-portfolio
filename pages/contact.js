                ...
                <ul class="space-y-4">
                  <li class="flex items-center gap-3">
                    <svg
                      ...
                      class="w-6 h-6 text-slate-700 flex-shrink-0"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      aria-hidden="true"
                    ...
                    <a href="mailto:davemadhav2007@gmail.com" class="hover:underline">
                  ...
                  <li class="flex items-center gap-3">
                    ...
                    >
                      <path
                        ...
                        stroke-linejoin="round"
                        stroke-width="2"
                        d="M3 5a2 2 0 012-2h2.5a2 2 0 011.7.9l1.2 1.8a2 2 0 01-.2 2.4L7.7 10.7a11.04 11.04 0 005.6 5.6l1.6-1.5a2 2 0 012.4-.2l1.8 1.2A2 2 0 0120 18.5V21a2 2 0 01-2 2A18 18 0 013 5z"
                      />
                    </svg>
